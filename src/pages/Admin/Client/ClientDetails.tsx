    ...
    return (
      <div className="min-h-screen bg-slate-50 px-4 py-6 transition-colors duration-300 dark:bg-slate-950 md:px-8 md:py-10">
        <div className="mx-auto max-w-6xl">
          <div className="animate-pulse overflow-hidden rounded-[28px] border border-white/60 bg-white shadow-[0_20px_80px_rgba(15,23,42,0.08)] dark:border-slate-800 dark:bg-slate-900">
            <div className="h-52 bg-linear-to-r from-violet-600 via-indigo-600 to-blue-600 md:h-60" />
            <div className="px-5 pb-6 md:px-8 md:pb-8">
              ...
              <div className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-3">
                ...
                <div className="space-y-5">
                  <div className="h-48 rounded-[24px] bg-white dark:bg-slate-900" />
      ...
      <motion.div initial="hidden" animate="visible" className="mx-auto max-w-6xl">
        ...
        >
          <div className="relative h-48 overflow-hidden bg-linear-to-r from-violet-600 via-indigo-600 to-blue-600 md:h-60">
            ...
            >
              <div>
                <p className="text-sm font-medium uppercase tracking-[0.22em] text-white/70">Client Profile</p>
                <h1 className="mt-2 text-2xl font-bold text-white md:text-4xl">Client Details</h1>
                <p className="mt-2 max-w-xl text-sm text-white/80 md:text-base">
                  A complete overview of client profile, contact information and account details.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            >
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-3">
                      <h2 className="text-2xl font-bold text-slate-900 dark:text-white md:text-3xl">{name || "Unnamed Client"}</h2>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:min-w-70">
                  ...
                  <StatCard label="Phone" value={phone || "N/A"} />
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-5 lg:col-span-2">
                <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900 md:p-6">
                  <div className="mb-5 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white">Client Information</h3>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Basic client identity and contact details.</p>
                    </div>
                  </div>

                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <InfoCard icon={<UserRound className="h-5 w-5 text-slate-700 dark:text-slate-200" />} label="Client Name" value={name || "N/A"} />
                ...
                <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900 md:p-6">
                  <div className="mb-5 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">Unique client reference details.</p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/60">
                    <p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Client ID</p>
