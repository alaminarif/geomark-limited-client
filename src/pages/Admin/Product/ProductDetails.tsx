...
import { ArrowLeft, MapPin, ShoppingCart, MessageCircle, PackageCheck, Sparkles, Pencil } from "lucide-react";
          ...
          >
            <div className="rounded-3xl border border-border bg-background/50 p-6 shadow-sm backdrop-blur md:p-8">
              ...
              >
                ...
                {product?.location && (
                  <div className="w-full rounded-2xl border border-border bg-background/60 p-4 transition hover:-translate-y-1 2xl:col-span-2">
                    <div className="flex items-start gap-3">
              ...
              <motion.div
                ...
                className="mt-8 grid grid-cols-1 gap-3 2xl:grid-cols-2"
              >
                <motion.button
                  whileHover={{ scale: 1.02, y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  // onClick={handleBuyNow}
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-linear-to-r from-purple-500 to-blue-500 px-6 py-3.5 text-sm font-semibold text-primary-foreground transition hover:opacity-95"
                >
                ...
                <motion.button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-border bg-background px-6 py-3.5 text-sm font-semibold text-foreground transition hover:bg-muted"
                >
