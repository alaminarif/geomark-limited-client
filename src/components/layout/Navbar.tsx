        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex-1 md:flex md:items-center md:gap-12">
            <a className="block text-teal-600 dark:text-teal-300" href="#">
              ...
              <img src={logo} alt="image" className="size-10 object-cover" />
          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                ...
                <div className="hidden sm:flex">
                  <a className="rounded-md bg-ring px-5 py-2.5 text-sm font-medium text-secondary-300" href="#">
                    Register
                  </a>
                </div>
              </div>
              ...
              <div className="block md:hidden">
                <button className="rounded-sm bg-primary p-2 text-gray-600 transition hover:text-gray-600/75">
            ...
            {/* <div className="relative hidden md:block">
              <button type="button" className="overflow-hidden rounded-full border border-gray-300 shadow-inner dark:border-gray-600">
                ...
                <img src="" alt="image" className="size-10 object-cover" />
              </button>
