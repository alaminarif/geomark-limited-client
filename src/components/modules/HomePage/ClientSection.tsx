...
export const ClientSection = ({ className, items = [], autoPlay = true, showAutoPlayToggle = true }: ClientSectionProps) => {
  ...
  return (
    <section className={cn("container mx-auto relative overflow-hidden py-20", className)}>
      <div className="px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3 self-start md:self-auto">
            {totalPages > 1 && (
              <>
                <button
                  ...
                  className="inline-flex size-11 items-center justify-center rounded-full border border-blue-400 bg-background/80 text-blue-600 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-blue-600 hover:text-white dark:text-white"
                >
                ...
                {showAutoPlayToggle && (
                  <button
                    ...
                    className="inline-flex h-11 min-w-27.5 items-center justify-center gap-2 rounded-full border border-blue-400 bg-background/80 px-4 text-sm font-medium text-blue-600 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-blue-600 hover:text-white dark:text-white"
                  >
            ...
            <Link
              to="/client"
              className="inline-flex h-11 items-center justify-center rounded-full bg-blue-800 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700"
            >
              View All
            </Link>
          </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-2">
            {pages.map((_, index) => (
              <button
                key={index}
                type="button"
                aria-label={`Show client page ${index + 1}`}
